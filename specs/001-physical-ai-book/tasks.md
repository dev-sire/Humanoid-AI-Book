...
- [X] T002 Configure `docusaurus.config.js` with basic project metadata
- [X] T003 Configure `sidebars.js` for initial chapter structure
- [X] T004 Create GitHub Actions workflow for Docusaurus deployment in .github/workflows/deploy.yml

## Phase 2: Foundational

*Core prerequisites that block user story implementation.*

- [X] T005 Define and create chapter template in docs/_templates/chapter.md
- [X] T006 Establish a glossary in docs/glossary.md
- [X] T007 Create main `index.js` page in src/pages/index.js
- [X] T008 Add base CSS styling in src/css/custom.css
...
- [X] T009 [US1] Draft Chapter 1: Introduction to Physical AI in docs/chapter-1.md
- [X] T010 [P] [US1] Add core concepts explanation to docs/chapter-1.md
- [X] T011 [P] [US1] Include initial diagrams/figures as placeholders in docs/chapter-1.md
- [X] T012 [US1] Draft Chapter 2: ROS 2 Fundamentals in docs/chapter-2.md
- [X] T013 [P] [US1] Add basic ROS 2 code examples to docs/chapter-2.md
- [X] T014 [US1] Draft Chapter 3: Digital Twin & Simulation in docs/chapter-3.md
- [X] T015 [P] [US1] Include simulation setup and basic control examples in docs/chapter-3.md
- [X] T016 [US1] Draft Chapter 4: NVIDIA Isaac Integration in docs/chapter-4.md
- [X] T017 [P] [US1] Add Isaac Sim integration examples to docs/chapter-4.md
- [X] T018 [US1] Draft Chapter 5: Vision-Language-Action (VLA) Models in docs/chapter-5.md
- [X] T019 [P] [US1] Include VLA concept explanations and potential code snippets in docs/chapter-5.md
- [X] T020 [US1] Draft Chapter 6: Humanoid Control & Deployment in docs/chapter-6.md
- [X] T021 [P] [US1] Add basic humanoid control and deployment considerations to docs/chapter-6.md
- [X] T022 [US1] Validate all code examples in chapters for accuracy (manual review + execution)
...
- [X] T023 [US2] Integrate weekly breakdowns into each chapter's frontmatter or dedicated section
- [X] T024 [P] [US2] Create module summaries for each major section of the book in docs/
- [X] T025 [US2] Generate an example 13-week course syllabus based on book structure in docs/syllabus.md

## Phase 5: Polish & Cross-Cutting Concerns

*Final validation, quality checks, and non-functional requirements.*

- [X] T026 Ensure consistent voice, terminology, and chapter format across all chapters
- [X] T027 Verify all factual claims include IEEE-style citations; mark unverifiable claims as TODO
